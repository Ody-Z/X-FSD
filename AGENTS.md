...
- [Analytics](docs/analytics.md) - local reply event storage, X API v2 metric sync, dashboard metrics.
...
- Local analytics dashboard for reply volume, impressions, profile clicks, profile intent, reply types, and target categories.
...
- If a change touches reply analytics events, metric sync, or the dashboard, update [Analytics](docs/analytics.md).
